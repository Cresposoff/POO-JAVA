package ejerciciosjava.Parqueaderos;

import ejerciciosjava.Parqueaderos.exceptions.EspaciosInsuficientesException;
import ejerciciosjava.Parqueaderos.exceptions.MaximoCamionesException;
import ejerciciosjava.Parqueaderos.exceptions.MaximoMotosException;
import ejerciciosjava.Parqueaderos.exceptions.VehiculoYaRegistradoException;
import ejerciciosjava.Parqueaderos.garages.Empresa;
import ejerciciosjava.Parqueaderos.garages.Garage;
import ejerciciosjava.Parqueaderos.vehicles.Auto;
import ejerciciosjava.Parqueaderos.vehicles.Camion;
import ejerciciosjava.Parqueaderos.vehicles.Moto;
import ejerciciosjava.Parqueaderos.vehicles.Vehiculo;
import ejerciciosjava.Parqueaderos.vehicles.*;
